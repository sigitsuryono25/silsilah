...
<html>
    ...
    <body>
        ...
        <!--FrontEnd-->
        <div class="modal fade" style="z-index: 9999999" id="modal-detail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
...
//            for frontend
                function showDetail(memberId) {
                    var url = "<?php echo site_url('silsilah/getDetailMember/') ?>" + memberId;
                    $.get(url, null, function (data) {
                        $(".response-detail").html(data);
                    });
